...
// src AppBundle/Request/GuzzleRequest.php

namespace AppBundle\Request;

use AppBundle\Exceptions\ServiceNotAvailableException;
use AppBundle\Specifications\StatusNotOkSpecification;
use Psr\Http\Message\ResponseInterface;
use GuzzleHttp;
use AppBundle\Normalizer\INormalizer;
